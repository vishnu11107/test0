...
export const users = pgTable('users', {
  ...
  image: text('image'),
  subscriptionTier:
    subscriptionTierEnum('subscription_tier').default('free_trial'),
...
export const agents = pgTable(
  ...
  (table) => ({
    ...
    userNameIdx: uniqueIndex('agents_user_name_idx').on(
      table.userId,
      table.name
    ),
  })
...
export const meetings = pgTable(
  ...
  (table) => ({
    ...
    userStatusIdx: index('meetings_user_status_idx').on(
      table.userId,
      table.status
    ),
    streamCallIdIdx: index('meetings_stream_call_id_idx').on(
      table.streamCallId
    ),
  })
);
